...
export default function SeriesDetails() {
    ...
    useEffect(() => {
        if (!id)
            return;
        const localSeries = JSON.parse(localStorage.getItem('custom-series') || '[]');
    ...
    return (<div className="p-6 max-w-5xl mx-auto">
      <img src={series.image
            ? series.image
            : `https://image.tmdb.org/t/p/w500${series.poster_path}`} className="rounded-xl mb-6 w-full max-h-[500px] object-cover"/>
